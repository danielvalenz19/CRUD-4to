...
public class Catedratico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Agregar Catedratico");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        agregarCatedratico.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Catedratico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Catedratico().setVisible(true);
            }
        });
    }
